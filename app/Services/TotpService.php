...
class TotpService
{
    ...
    {
        // The issuer is what the user sees naming this account in their
        // authenticator app, so default it to whichever brand they signed in
        // under rather than the platform's own name.
        $issuer ??= \App\Support\Brand::name();
