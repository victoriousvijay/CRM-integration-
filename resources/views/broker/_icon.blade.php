{{--
    Inline SVG icons for the broker portal.

    Inline rather than an icon font or a sprite sheet: the site's own
    Content-Security-Policy allows images only from `self`, `data:` and `blob:`,
    so a CDN sprite silently renders nothing. These are drawn in the same
    24×24 stroke style as the rest of the UI.
...
@php
    ...
    $paths = [
        ...
        'bed' => '<path d="M3 7v11m0 -4h18m0 4v-7a2 2 0 0 0 -2 -2h-8v6"/><path d="M7 10m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/>',
        'bath' => '<path d="M4 12h16a1 1 0 0 1 1 1v3a4 4 0 0 1 -4 4h-10a4 4 0 0 1 -4 -4v-3a1 1 0 0 1 1 -1z"/><path d="M6 12v-7a2 2 0 0 1 2 -2h3v2.25"/><path d="M4 21l1 -1.5"/><path d="M20 21l-1 -1.5"/>',
        ...
        'note' => '<path d="M13 20l7 -7"/><path d="M13 20v-6a1 1 0 0 1 1 -1h6v-7a2 2 0 0 0 -2 -2h-12a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2z"/>',
