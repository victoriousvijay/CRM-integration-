...
@section('title', __('Create Document Template'))
@section('page-title', __('Create Document Template'))
...
@section('content')
<form method="POST" action="{{ route('document-templates.store') }}" id="template-form">
    @csrf
    <div class="row">
        {{-- Left: Editor --}}
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="{{ __('e.g., Standard LOI') }}" required>
                            @error('name')
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="is_default" value="1" class="form-check-input" id="is-default" {{ old('is_default') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.starter-template-btn').forEach(function(btn) {
        btn.addEventListener('click', function(e) {
            ...
            if (starterTemplates[key]) {
                ...
                // Also set name and type if empty
                var nameInput = document.querySelector('input[name="name"]');
                var typeSelect = document.querySelector('select[name="type"]');
                if (!nameInput.value) nameInput.value = starterTemplates[key].name;
                if (!typeSelect.value) typeSelect.value = starterTemplates[key].type;
            }
        });
    });
    ...
    document.getElementById('preview-btn').addEventListener('click', function() {
        ...
        // Use a temporary preview endpoint — post content directly
        fetch('{{ url("/document-templates/preview-content") }}', {
            method: 'POST',
            headers: {
